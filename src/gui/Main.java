...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 110, 90, -1));
        jPanel1.add(txtLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 150, 90, 30));
        ...
        jPanel1.add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 150, 110, 30));
        ...
        jPanel1.add(bnConnexion, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 200, -1, -1));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 240, 140, -1));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/authentification.png"))); // NOI18N
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, 80, 190, 220));
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        if (login != null && !login.trim().isEmpty()) {
            ...
            if (userService.userExists(login)) {
                String[] options = {"Question secrète", "Email"};
                ...
                if (choice == 0) {
                    String securityQuestion = userService.getSecurityQuestion(login);

                    if (securityQuestion != null) {
                        String securityAnswer = JOptionPane.showInputDialog(this, securityQuestion);

                        if (securityAnswer != null && securityAnswer.equalsIgnoreCase(userService.getSecurityAnswer(login))) {
                        ...
                        JOptionPane.showMessageDialog(this, "Aucune question secrète trouvée pour ce login.");
                    }
                } else if (choice == 1) {
                    ...
                    if (email != null) {
                        ...
                        boolean emailSent = userService.sendRecoveryEmail(email, code);

                        if (emailSent) {
                            String userCode = JOptionPane.showInputDialog(this, "Veuillez entrer le code reçu par email :");
                        ...
                        JOptionPane.showMessageDialog(this, "Aucune adresse email associée à ce compte.");
                    }
                }
            } else {
